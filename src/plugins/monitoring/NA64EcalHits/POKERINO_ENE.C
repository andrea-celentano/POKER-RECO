...

{
	...
	TH1D *h[nChannels];
	h[0]= (TH1D*)gDirectory->FindObjectAny("hE_x1_y1");
	h[1]= (TH1D*)gDirectory->FindObjectAny("hE_x0_y0");
	h[2]= (TH1D*)gDirectory->FindObjectAny("hE_x1_y0");
	h[3]= (TH1D*)gDirectory->FindObjectAny("hE_x2_y0");
	h[4]= (TH1D*)gDirectory->FindObjectAny("hE_x0_y1");
	h[5]= (TH1D*)gDirectory->FindObjectAny("hE_x2_y1");
	h[6]= (TH1D*)gDirectory->FindObjectAny("hE_x0_y2");
	h[7]= (TH1D*)gDirectory->FindObjectAny("hE_x1_y2");
